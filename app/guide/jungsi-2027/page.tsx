        ...
        <section className="mt-14 rounded-lg border border-white/10 bg-[#0a0a0a] p-6">
          ...
          <ul className="mt-3 space-y-3 text-sm leading-relaxed text-white/60">
            <li>
              ...
              1일 게시된 2027학년도 정시 모집요강 원본을 대조해 반영했습니다.
              상명대만 9월 3일 기준 2027 정시 요강이 게시되지 않아 시행계획
              기준이며, 게시되는 대로 업데이트합니다. 경쟁률(수시이월 반영 최종
              마감)·합격선은 2026학년도 정시 입시결과 기준입니다. 수시 이월을
              반영한 최종 모집인원은 각 대학이 12월 말 다시 공지합니다.
            </li>
            <li>
