      ...
      <article className="mx-auto max-w-4xl px-5 pt-28 pb-20">
        ...
        <header className="mb-16 text-center">
          ...
          <p className="mt-4 text-[13px] leading-relaxed text-white/45">
            2027학년도 대학별 정시 모집요강(가군) 및 대입전형 시행계획 기준 ·
            2026년 9월 갱신
          </p>
...
어느 대학에 갈 수 있는지는 결국 성적이 정하지만, 어느 대학을 노려볼 수 있는지는 준비한 실기 종목이 먼저 가릅니다. 종목이 다르면 준비 방식이 완전히 달라 중간에 갈아타기 어렵습니다. 실제 시험 종목 기준으로 정리했으니, 대표 종목 두 가지를 예시작과 함께 보고 나머지 종목까지 확인한 뒤 군별 대학 표를 보면 지원 전략이 훨씬 선명해집니다.{" "}
        ...
        <section className="mt-14 rounded-lg border border-white/10 bg-[#0a0a0a] p-6">
          ...
          <ul className="mt-3 space-y-3 text-sm leading-relaxed text-white/60">
            <li>
              가군 대학(서울대·이화여대 포함)의 학과별 모집인원·수능
              반영영역·실기내용·화지규격은 2026년 8월 31일~9월 1일 게시된
              2027학년도 정시 모집요강 원본을 대조해 반영했습니다. 나·다군은
              2026학년도 정시 모집요강과 2027학년도 시행계획 기준이며, 2027
              요강을 대조하는 대로 순차 업데이트합니다. 경쟁률(수시이월 반영
            ...
            <li>
              ...
              옮겼으며, 성신여대 미술대학(동양화·서양화·조소)은 가군 정시로
              돌아왔습니다. 한국예술종합학교는 2027 예술사 모집요강 기준입니다.
            </li>
          </ul>
        </section>
