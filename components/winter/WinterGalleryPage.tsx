...
const PARENT_CONCERNS = [
  {
    q: "휴대폰은 어떻게 하나요?",
    a: "입소 전에 집에 두고 오시도록 안내드립니다. 8주 동안 아예 소지하지 않아 취침·기상 시간과 생활 리듬이 무너지지 않습니다. 학부모님과의 연락은 본원으로 전화 주시면 언제든 가능합니다.",
    icon: Moon,
  },
  {
    q: "식사는 잘 챙겨 먹을까요?",
  ...
  {
    q: "공부는 제대로 하나요?",
    a: "평일 매일 밤 영단어 100개 시험(주 500단어, 8주간 4,000단어), 주 2회 국어·영어 모의고사로 매일의 학습을 숫자로 확인합니다.",
    icon: BookOpen,
  },
  {
    q: "아이 소식은 어떻게 듣나요?",
...
const LIFE_FAQ = [
  {
    q: "핸드폰은 아예 사용할 수 없나요?",
    a: "네. 처음 윈터스쿨에 들어오기 전에 휴대폰을 집에 두고 오시도록 안내드리고, 8주 동안 소지하지 않습니다. 학생과 통화가 필요하시면 본원으로 전화 주시면 언제든 연결해 드립니다.",
  },
  {
    q: "주말 귀가나 외출이 가능한가요?",
    a: "정해진 주말 귀가·외출 규정은 따로 두고 있지 않습니다. 다만 학부모님께서 요청하시면 외출을 허가해 드립니다.",
  },
  {
    q: "준비물은 무엇인가요?",
    a: "개인 세면도구와 의류 등 기본 생활용품을 준비하시면 됩니다. 실기 재료는 학원에서 제공하고, 휴대폰은 집에 두고 오시면 됩니다. 상세 목록은 등록 후 안내드립니다.",
  },
];
