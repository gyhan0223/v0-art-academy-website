 ...
 *   학과 강사는 전원 담당 수업 시간에 들어오는 출강이다. 그래서 학과 강사는
 ...
 *
 * 옮기면서 뺀 줄과 이유:
 * · "현) 아름다운학원 …" 전원 — 이 페이지가 곧 소속이라 반복될 뿐이다.
...
export const TEACHERS: Teacher[] = [
  ...
  // 임성준(사회탐구) — 쓸 수 있는 실사 프로필이 없어 혼자만 이니셜 자리표시자로
  // 떴다. 아홉 명이 사진인데 한 명만 글자면 그 한 명이 더 눈에 띈다. 사진이
  // 준비되면 위 형식대로 다시 넣으면 상단 숫자와 과목 섹션이 따라 붙는다.
  {
    id: "lee-myeongsin",
    name: "이명신",
    subject: "사회탐구",
